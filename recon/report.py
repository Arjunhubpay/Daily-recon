...
IT_COLS = ["Status", "Amount", "Currency", "Source", "Destination",
           "Credit Found In", "Ref", "Note"]
...
def write_html(result: dict, path: Path, lsum: dict = None, transfers=None):
    ...
    it_cols = [("Status", ""), ("Amount", "num"), ("Currency", ""), ("Source", ""),
               ("Destination", ""), ("Credit Found In", ""), ("Ref", ""), ("Note", "desc")]
